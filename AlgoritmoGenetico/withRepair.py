...
# Esta implementacao do algoritmo genetico se da com reparo, ou seja, 
# se o individuo gerado nao atender as restricoes, ele sera reparado
# realizando uma inversao de bit aleatoria
